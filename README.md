...
![Version](https://img.shields.io/badge/version-2.3.0-blueviolet) ![WordPress](https://img.shields.io/badge/WordPress-5.8%2B-blue) ![PHP](https://img.shields.io/badge/PHP-7.4%2B-777bb4) ![Licence](https://img.shields.io/badge/licence-GPL--2.0-green)
...
- **Catalogue produits en temps réel** (WooCommerce) : Naya connaît **tous** les produits du site. À chaque question, elle cherche les produits concernés dans un index léger (plusieurs milliers de produits, recherche en ~50 ms) puis lit en direct leur **prix, promotion, stock et tailles/couleurs encore disponibles**. Elle comprend les budgets (« moins de 20 000 FCFA »), les promotions, « le moins cher », les meilleures ventes, les synonymes (smartphone → téléphones), les références et les relances (« et en XL ? »). Si rien ne correspond, elle le dit — jamais de produit inventé. Nom de la boutique du vendeur sur les places de marché Dokan et WCFM.
